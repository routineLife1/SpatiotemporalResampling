...
from models.model_union_2.gmflow.gmflow import GMFlow
from models.model_union_2.IFNet_HDv3 import IFNet
from models.model_union_2.MetricNet import MetricNet
from models.model_union_2.FusionNet import AnimeInterp
...
class Model:
    ...
    def get_flow(self,I0,I1,vector=-1):
        if vector == -1:
            return self.flownet(I1,I0)
        return self.flownet(I0,I1)
